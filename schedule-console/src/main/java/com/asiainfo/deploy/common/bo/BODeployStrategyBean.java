...
public class BODeployStrategyBean extends DataContainer implements DataContainerInterface, IBODeployStrategyValue {

	private static String m_boName = "com.asiainfo.deploy.common.bo.BODeployStrategy";
	...
	public BODeployStrategyBean() throws AIException {
		super(S_TYPE);
	}
