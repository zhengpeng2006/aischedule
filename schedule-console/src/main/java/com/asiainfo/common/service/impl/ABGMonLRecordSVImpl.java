...
import com.asiainfo.monitor.busi.exe.task.service.impl.AIMonLRecordSVImpl;
...
public class ABGMonLRecordSVImpl implements IABGMonLRecordSV
{
    ...
    public IBOABGMonLRecordValue[] queryRecord(String infoId) throws RemoteException, Exception
    {
        ...
        IABGMonLRecordDAO recordDao = (IABGMonLRecordDAO) ServiceFactory.getService(IABGMonLRecordDAO.class);
     ...
     * @throws Exception
     */
    public List getMonLRecordImage(Object[] infoIds, String groupId, String viewTpyeId, Date startDate, Date endDate) throws RemoteException,
            Exception
    {
        List result = null;
        try {
