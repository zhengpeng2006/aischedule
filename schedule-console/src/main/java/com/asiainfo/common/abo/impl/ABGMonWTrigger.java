...
import com.asiainfo.common.abo.interfaces.IABGMonWTrigger;

import java.sql.Timestamp;

public class ABGMonWTrigger extends AbstractABO implements IABGMonWTrigger
{

    private transient static Log log = LogFactory.getLog(ABGMonWTrigger.class);
    ...
    private ABGMonWTrigger(String id)
    {
        super();
        this.trigger_Id = Long.parseLong(id);
        this.setComponent("asiainfo/common/Common.cmpt");
    }

    public void setTrigger_Id(long trigger_Id)
    {
        this.trigger_Id = trigger_Id;
        this.setKey(String.valueOf(trigger_Id));
    }
