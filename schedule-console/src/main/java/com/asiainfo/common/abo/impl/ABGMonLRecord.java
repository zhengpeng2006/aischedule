...
import com.asiainfo.common.abo.interfaces.IABGMonLRecord;

import java.sql.Timestamp;

public class ABGMonLRecord extends AbstractABO implements IABGMonLRecord
{

    private transient static Log log = LogFactory.getLog(ABGMonLRecord.class);
    ...
    private ABGMonLRecord(String id)
    {
        super();
        this.record_id = Long.parseLong(id);
    ...
    public void setRecord_id(long record_id)
    {
        ...
        this.setKey(String.valueOf(record_id));
    }
