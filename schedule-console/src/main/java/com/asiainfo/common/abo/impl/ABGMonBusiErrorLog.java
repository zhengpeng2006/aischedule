...
import com.asiainfo.common.abo.interfaces.IABGMonBusiErrorLog;
import com.asiainfo.common.abo.vo.interfaces.IABGMonBusiErrorLogValue;
import java.sql.Timestamp;

public class ABGMonBusiErrorLog extends AbstractABO implements
		IABGMonBusiErrorLog {

	private transient static Log log = LogFactory
			.getLog(ABGMonBusiErrorLog.class);
	...
	private ABGMonBusiErrorLog(String id) {
		super();
		this.err_order_id = Long.parseLong(id);
		this.setComponent("asiainfo/common/ABGMonBusiErrorLog.cmpt");
	}

	public IABGMonBusiErrorLogValue getIABGMonBusiErrorLogValue()
			throws Exception {
		return (IABGMonBusiErrorLogValue) DataBeanUtils.getVoByAboAndCopy(this,
				true);
	}

	public void setErr_order_id(long err_order_id) {
		this.err_order_id = err_order_id;
		this.setKey(String.valueOf(err_order_id));
	}
