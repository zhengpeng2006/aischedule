...
public class ABGMonBusiLogValueBean extends AbstractValueBean implements
		IABGMonBusiLogValue {

	private transient static Log log = LogFactory
			.getLog(ABGMonBusiLogValueBean.class);
