...
public interface IAIMonLRecordSV {
	 ...
	 * @throws Exception
	 */
	public List getMonLRecordImage(Object[] infoId, String groupId, String viewTpyeId, Date startDate, Date endDate) throws RemoteException,Exception;
