...
public class BOAIMonDBURLBean extends DataContainer implements DataContainerInterface,IBOAIMonDBURLValue{

    private static String m_boName = "com.asiainfo.monitor.busi.exe.task.bo.BOAIMonDBURL";
  ...
  public BOAIMonDBURLBean() throws AIException{
      super(S_TYPE);
  }
