...
public class BOAIMonWTriggerHisBean extends DataContainer implements DataContainerInterface,IBOAIMonWTriggerHisValue{

    private static String m_boName = "com.asiainfo.monitor.busi.exe.task.bo.BOAIMonWTriggerHis";
  ...
  public BOAIMonWTriggerHisBean() throws AIException{
      super(S_TYPE);
  }
