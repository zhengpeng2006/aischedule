...
public class BOAIMonStaticDataBean extends DataContainer implements DataContainerInterface,IBOAIMonStaticDataValue{

  private static String  m_boName = "com.asiainfo.monitor.exeframe.config.bo.BOAIMonStaticData";
  ...
  public BOAIMonStaticDataBean() throws AIException{
      super(S_TYPE);
  }
