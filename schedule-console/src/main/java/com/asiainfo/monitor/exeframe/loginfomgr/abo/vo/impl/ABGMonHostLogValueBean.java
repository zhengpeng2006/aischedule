package com.asiainfo.monitor.exeframe.loginfomgr.abo.vo.impl;
...
public class ABGMonHostLogValueBean extends AbstractValueBean implements IABGMonHostLogValue
{

    private transient static Log log = LogFactory.getLog(ABGMonHostLogValueBean.class);
