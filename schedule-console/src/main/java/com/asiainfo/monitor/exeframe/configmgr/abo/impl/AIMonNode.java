...
import com.asiainfo.monitor.exeframe.configmgr.abo.interfaces.IAIMonNode;
import com.asiainfo.monitor.exeframe.configmgr.abo.vo.interfaces.IAIMonNodeValue;
import java.sql.Timestamp;

public class AIMonNode extends AbstractABO implements IAIMonNode
{

    private transient static Log log = LogFactory.getLog(AIMonNode.class);
    ...
    private AIMonNode(String id)
    {
        super();
        this.node_id = Long.parseLong(id);
        this.setComponent("asiainfo/monitor/exeframe/configmgr/AIMonNode.cmpt");
    }

    public IAIMonNodeValue getIAIMonNodeValue() throws Exception
    {
        return (IAIMonNodeValue) DataBeanUtils.getVoByAboAndCopy(this, true);
    }

    public void setNode_id(long node_id)
    {
        this.node_id = node_id;
        this.setKey(String.valueOf(node_id));
    }
