...
public class BOAIMonUserGroupBean extends DataContainer implements DataContainerInterface,IBOAIMonUserGroupValue{

  private static String  m_boName = "com.asiainfo.monitor.exeframe.config.bo.BOAIMonUserGroup";
  ...
  public BOAIMonUserGroupBean() throws AIException{
      super(S_TYPE);
  }
