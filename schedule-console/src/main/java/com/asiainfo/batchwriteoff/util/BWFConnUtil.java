 ...
 * <p> @version 1.0 </p>
 */
public class BWFConnUtil {
	private final static transient Log log = LogFactory.getLog(BWFConnUtil.class);
	...
	private static final String DATA_SOURCE_AOMP = "aomp";
	...
	public static Connection getTransactionAbleWriteAbleBaseConn(String regionId) throws Exception {
		return ServiceManager.getSession().getConnection(getRealDataSource("base",regionId));
	}
	 ...
	 * 获得AOMP可写连接
		...
		* Mar 7, 2012 4:47:40 PM       yanrg                 v1.0.0
	 */
	public static Connection getTransactionAbleWriteAbleAompConn(String regionId) throws Exception {
		return  ServiceManager.getSession().getConnection(getRealDataSource(DATA_SOURCE_AOMP,regionId));
	}
	 ...
	 */
	public static String getDeleteTmpTableSql(String tempTable) {
