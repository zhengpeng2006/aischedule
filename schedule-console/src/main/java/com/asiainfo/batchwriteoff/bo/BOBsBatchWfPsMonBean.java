...
public class BOBsBatchWfPsMonBean extends DataContainer implements DataContainerInterface,IBOBsBatchWfPsMonValue {

  private static String  m_boName = "com.asiainfo.crm.common.bo.BOBsBatchWfPsMon";
  ...
  public BOBsBatchWfPsMonBean() throws AIException {
      super(S_TYPE);
  }
