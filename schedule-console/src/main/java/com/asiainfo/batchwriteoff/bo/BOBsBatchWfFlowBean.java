...
public class BOBsBatchWfFlowBean extends DataContainer implements DataContainerInterface,IBOBsBatchWfFlowValue {

  private static String  m_boName = "com.asiainfo.crm.common.bo.BOBsBatchWfFlow";
  ...
  public BOBsBatchWfFlowBean() throws AIException {
      super(S_TYPE);
  }
